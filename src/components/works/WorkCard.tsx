...
export default function WorkCard({ work }: WorkCardProps) {
  return (
    <Link
      ...
      className="group block rounded-[28px] border border-border/70 bg-white/65 p-6 shadow-[0_16px_45px_rgba(38,88,84,0.035)] transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-[0_18px_45px_rgba(30,78,76,0.07)]"
    >
